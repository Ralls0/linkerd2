...
replace github.com/linkerd/linkerd2-proxy-api => github.com/liqotech/linkerd2-proxy-api v0.1.19-0.20210825161558-3cc9152f0f80
...
//
//replace github.com/liqotech/liqo => github.com/giandonatoFarina/liqo v0.2.2-0.20210818143043-1a31ae1dca7b
